...
public class FMLConfig
{
    public enum ConfigValue {
        ...
        DISABLE_OPTIMIZED_DFU("disableOptimizedDFU", Boolean.FALSE, "Disables Optimized DFU client-side - already disabled on servers"),
        EARLY_WINDOW_PROVIDER("earlyWindowProvider", "fmlearlywindow", "Early window provider"),
        EARLY_WINDOW_WIDTH("earlyWindowWidth", 1495, "Early window width"),
        EARLY_WINDOW_HEIGHT("earlyWindowHeight", 840, "Early window height"),
        ...
        EARLY_WINDOW_SHOW_CPU("earlyWindowShowCPU", Boolean.TRUE, "Whether to show CPU usage stats in early window"),
